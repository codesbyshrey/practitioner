...
function encryptText(text, key) {
     ...
     for(let i = 0; i < text.length; i++) {
          ...
          if(textIndex === -1) {
               // if textIndex doesn't exist in the input
...
// Add our event listeners for the specific buttons
...
// Initialize result w/ encrypted text upon loading
